...
public class REVDigitBoard
{
	...
	REVDigitBoard()
	{
		...
		charreg[0][1] = (byte) 0b00000000; // 0
		charmap.put('0', 0);
		charreg[1][0] = (byte) 0b00000110;
		charreg[1][1] = (byte) 0b00000000; // 1
		charmap.put('1', 1);
		charreg[2][0] = (byte) 0b11011011;
		charreg[2][1] = (byte) 0b00000000; // 2
		charmap.put('2', 2);
		charreg[3][0] = (byte) 0b11001111;
		charreg[3][1] = (byte) 0b00000000; // 3
		charmap.put('3', 3);
		charreg[4][0] = (byte) 0b11100110;
		charreg[4][1] = (byte) 0b00000000; // 4
		charmap.put('4', 4);
		charreg[5][0] = (byte) 0b11101101;
		charreg[5][1] = (byte) 0b00000000; // 5
		charmap.put('5', 5);
		charreg[6][0] = (byte) 0b11111101;
		charreg[6][1] = (byte) 0b00000000; // 6
		charmap.put('6', 6);
		charreg[7][0] = (byte) 0b00000111;
		charreg[7][1] = (byte) 0b00000000; // 7
		charmap.put('7', 7);
		charreg[8][0] = (byte) 0b11111111;
		charreg[8][1] = (byte) 0b00000000; // 8
		charmap.put('8', 8);
		charreg[9][0] = (byte) 0b11101111;
		charreg[9][1] = (byte) 0b00000000; // 9
		charmap.put('9', 9);
	...
	void _display(int[] charz, int dp)
	{
		...
		if (0 <= dp && dp <= 3)
		{
			byte1[(3 - dp) * 2 + 2 + 1] |= (byte) 0b01000000;
		}
